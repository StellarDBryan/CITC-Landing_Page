...
const Tooltip = ({ facebook, instagram, twitter, linkedin, whatsapp}) => {
  return (
    <StyledWrapper>
      ...
      <li className="icon-content">
        ...
        {/* LinkedIn Button */}
        <li className="icon-content">
          <a href={instagram} aria-label="Instagram" data-social="instagram" target="_blank" rel="noopener noreferrer">
            <div className="filled" />
